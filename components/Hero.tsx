...
const Hero = () => {
  return (
    <section className="max-container padding-container flex flex-col-reverse gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row">
      ...
      <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
        ...
        <p className="regular-16 mt-4 text-gray-30 xl:max-w-[520px]">
          Premium cleaning liquid manufacturer in Pune.
        </p>
        <p className="regular-16 mt-4 text-gray-30 xl:max-w-[520px]">
      ...
      <div>
        <Image src={'/ahp_main_image.png'} alt='main_products' height={700} width={700} className=''/>
      </div>
    </section>
  )
}
